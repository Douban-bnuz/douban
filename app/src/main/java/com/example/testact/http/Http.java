...
import com.example.testact.app.App;
...
public class Http {
    ...
    protected static HttpURLConnection createHttpURLConnection(String url, String requestMethod, RequestParams params) {
        Log.i("RRL","->createHttpURLConnection");
        try {
            httpUrl = new URL(url);
    ...
    protected static String createGetUrl(String url, RequestParams params) {
        ...
        System.out.println("requestUrl:" + combinationUrl );
    ...
    public static void get(String url, RequestParams params, OnHttpListener listener) {
        if (!NetworkUtils.isAvailable(App.app)) {
            System.out.println("HTTP_URL:" +url);
            ...
            System.out.println("HTTP_URL:" +response.url());
            return;
        }
